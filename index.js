...
function promptInfo () {inquirer.prompt([
    { type:'input', name:'text', message: 'Input 3 character text',},
    { type:'input', name:'textcolor', message:'Enter color for your text',},
    { type:'input', name:'shape', message:'Choose the shape you would like', choices:['circle,triangle,rectangle'],} ,
...
<polygon points="150,10 240,180 60,180" fill="${.shapecolor}"></polygon> 
    <text x="146" y="170" font-size="40" text-anchor="middle" fill="${.textcolor}">SVG</text>
    </svg>}`;
...
`<rect x="65" y="40" width="150" height="100" fill="${.shapecolor}"></rect>
    <text x="135" y="97" font-size="40" text-anchor="middle" fill="${.textcolor}">SVG</text>
    </svg>}`;
